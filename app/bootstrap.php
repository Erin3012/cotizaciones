...
ob_start(function(string $output): string { if (!str_contains($output, '<nav class="nav">')) return $output; $home='<a class="portal-home" style="display:flex;align-items:center;gap:8px;background:#3b3e40;color:#fff;margin-bottom:8px" href="https://portal.metalrubber.cl" title="Volver al Portal Metalrubber" aria-label="Volver al Portal Metalrubber"><span aria-hidden="true" style="font-size:1.25rem;line-height:1">⌂</span> Portal</a>'; return str_replace('<nav class="nav">',$home.'<nav class="nav">',$output); });
